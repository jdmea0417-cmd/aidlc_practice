...
**뼈대 구간의 인원** — B1 은 갈래 하나지만 **사람은 넷이 붙는다** (D-122). U1·U2·U3·U4 를 각 1인이 맡고, 남는 1인이 저장소 준비와
용어집·통합을 맡는다. "혼자"는 갈래 수를 말한 것이지 인원을 말한 것이 아니며, B1 승인 게이트는 네 단위가 다 끝난 뒤 한 번 그대로다.
네 사람의 출발선은 다르다 — U1 은 설계 네 단계가 끝나 코드 생성부터, 나머지 셋은 기능 설계부터 시작한다.
